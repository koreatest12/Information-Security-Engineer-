...
> **The Definitive Guide for Information Security Engineer Certification & Knowledge Base.** > 본 저장소는 정보보안기사 자격 취득을 위한 핵심 이론, 실무 기술, 법규 사항을 체계적으로 정리한 아카이브입니다.
...
* **Protocols:** HTTP/HTTPS 메커니즘, FTP(Active/Passive), SMTP/POP3/IMAP 보안.
